                ...
                >
                  ...
                  {showProgramas ?
                    ...
                    <IconButton
                      style={{ backgroundColor: 'transparent' }}
                      color="grey"
                      onClick={() => { setInputValueTema(null);setShowProgramas(false); setShowTemas(true); setPrograma(undefined); setInputValuePrograma(undefined); setActiveBar(MAIN_UNDERSEARCH_BAR);setZoomDefault((Math.random() * 999 + 1)); }}
                    >
